...
private:
	...
	vgui::TextEntry				*m_pMouseAccelerationLabel;

	CCvarSlider					*m_pMouseAccelerationSlider;
	...
	CCvarSlider					* m_pJoyPitchAccelerationSlider;
	vgui::Label					* m_pJoyPitchAccelerationPreLabel;
};
